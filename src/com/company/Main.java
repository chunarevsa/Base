...
" Горячие клавиши" /*
    ...
    "Getter and Seter" /* Необходим чтобы получить доступ к переменным private
    ...
    "\n"    //  - новой строки
    String[] st = "Hello World".split(" "); /* Разбиваем строку на два слова
...
" Видно Devcolibri 11 Условия и Циклы"  {
    ...
    for (String s : st) {} // Позволяет ходить по спискам.
        //Список состоит из строк. В переменную s будет по очереди помощены данные
...
" Видео Devcolibri Урок 22/23 Наследование/Полиморфизм/Абстарктные классы" {
   ...
   import People.People // импортируем класс если он находиться в другом пакете
    ...
    public abstract class Animal //{
        abstract void eat ();
        abstract void say (); //}
    public class Cat extends Animals {} // Вызвать абстрактный метод в Main
